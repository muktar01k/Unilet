    ...
    return (
        <div className=" ">
            <div className=" bg-Background bg-no-repeat h-[40rem] ">
                <div className="text-center lg:pt-[5rem] x:pt-[9rem] sam:pt-[8rem] lg:pt-[8rem]">
                    ...
                    <button className="mt-[1rem] w-[7rem] text-center bg-[black] text-[white] h-[2rem] rounded-xl" href="">{word3}</button>
                    {/* </div> */}
                </div>
            </div>
            ...
            <div className="">
                ...
                <p className="lg:text-center lg:w-[50rem] mt-[1rem] lg:ml-[18rem] xr:w-[410px] smm:w-[390px] sam:w-[360px] sam:text-center sam:font-semibold xr:text-center pro:text-center pro:w-[428px] x:text-center x:w-[374px] x:text-center">{word5}</p>
            </div>
            <div className="lg:flex lg:justify-center lg:gap-[5rem] pt-[3rem] xr:flex xr:flex-col xr:items-center xr:gap-[3rem] sam:flex sam:flex-col sam:items-center sam:gap-[3rem] pro:items-center x:flex x:flex-col x:items-center x:gap-[2rem]">

                <div className=" relative xr:text-center xr:bg-[white] xr:shadow-xl xr:w-[20rem] xr:pl-[5rem] xr:h-[17rem] xr:rounded-2xl sam:text-center sam:bg-[white] sam:shadow-xl sam:w-[19rem] sam:pl-[4rem] sam:h-[17rem] sam:rounded-2xl x:text-center x:bg-[white] x:shadow-xl x:w-[19rem] x:pl-[5rem] x:h-[17rem] x:rounded-2xl">
